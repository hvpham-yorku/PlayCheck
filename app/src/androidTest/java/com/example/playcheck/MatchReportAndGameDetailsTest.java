...
//        onView(withId(R.id.footGoalsA)).perform(scrollTo(), replaceText("3"), closeSoftKeyboard());
//        onView(withId(R.id.footGoalsB)).perform(scrollTo(), replaceText("1"), closeSoftKeyboard());
//        onView(withId(R.id.footShotsTeamA)).perform(scrollTo(), replaceText("12"), closeSoftKeyboard());
//        onView(withId(R.id.footYellowTeamA)).perform(scrollTo(), replaceText("1"), closeSoftKeyboard());
//        onView(withId(R.id.inputNotes)).perform(scrollTo(), replaceText("Clear victory for Team A."), closeSoftKeyboard());
//        onView(withId(R.id.submitButton)).perform(scrollTo(), click());
//
//    }
//
//    @Test
//    public void testSubmitBasketballReport() {
//        onView(withId(R.id.basketPointsTeamA)).perform(scrollTo(), replaceText("85"), closeSoftKeyboard());
//        onView(withId(R.id.basketPointsTeamB)).perform(scrollTo(), replaceText("78"), closeSoftKeyboard());
//        onView(withId(R.id.basketRebTeamA)).perform(scrollTo(), replaceText("40"), closeSoftKeyboard());
//        onView(withId(R.id.inputNotes)).perform(scrollTo(), replaceText("High scoring game."), closeSoftKeyboard());
//        onView(withId(R.id.submitButton)).perform(scrollTo(), click());
//    }
//
//
