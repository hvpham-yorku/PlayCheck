...
public class Organizer_Profile_Page_Controller extends AppCompatActivity {
    ...
    private EditText etTeamName, etUsername;
    private TextView tvTeamName, tvUsername, tvOrganizerName, tvScore;
    private View statsSection, statsCard;
    ...
    private void setupClickListeners() {
        ...
        findViewById(R.id.btnCancel).setOnClickListener(v -> toggleEditMode(false));
        findViewById(R.id.btnSave).setOnClickListener(v -> saveProfileChanges());
    ...
    private void loadUserProfile() {
        ...
        mDatabase.child("users").child("Organizer").child(currentUid).child("profile")
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        if (snapshot.exists()) {
                            ...
                            tvOrganizerName.setText(firstName + " " + lastName);
                            tvUsername.setText(username != null ? username : "N/A");
                            tvTeamName.setText(teamName != null ? teamName : "No Team");
                        }
                    }
    ...
    private void saveProfileChanges() {
        ...
        String newTeamName = etTeamName.getText().toString().trim();
        ...
        updates.put("teamName", newTeamName);
    ...
    private void toggleEditMode(boolean enable) {
        isEditMode = enable;
        if (addPhotoButton != null) addPhotoButton.setVisibility(enable ? View.VISIBLE : View.GONE);
        if (editActionButtons != null) editActionButtons.setVisibility(enable ? View.VISIBLE : View.GONE);
        
        if (etTeamName != null) etTeamName.setVisibility(enable ? View.VISIBLE : View.GONE);
        if (tvTeamName != null) tvTeamName.setVisibility(enable ? View.GONE : View.VISIBLE);
        ...
        if (enable) {
            if (etTeamName != null) etTeamName.setText(tvTeamName.getText());
            if (etUsername != null) etUsername.setText(tvUsername.getText());
        }
    }
